		...
		<input type = "hidden" name="ngayDangKy" id="ngayDangKy">
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="mb-3">
						<label for="tenDangNhap" class="form-label">Tên đăng nhập <span class="red">*</span>
						</label> <input type="text" class="form-control" id="tenDangNhap"name="tenDangNhap" required="required" value="<%=tenDangNhap%>">
					</div>
					<div class="mb-3">
				...
				<div class="col-sm-6">
					...
					<div class="mb-3">
						...
						<input type="checkbox" class="form-check-input" id="dongYDieuKhoan" name="dongYDieuKhoan" required="required" onchange="chonDongY()">
					</div>
					<div class="mb-3">
					...
					<input type="hidden" id="vaiTro" name="vaiTro"value="customer">
...
<script>
	function kiemTraMatKhau(){
		...
		var mkNhapLai = document.getElementById("matKhauNhapLai").value;
		
		if(mk!=mkNhapLai){
			document.getElementById("msg").innerHTML = "mat khau nhap lai khong khop"
				return false;
			}else{
